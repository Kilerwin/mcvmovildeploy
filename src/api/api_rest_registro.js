...
export const REGISTRO_USUARIO = async (data) => {
    try {
        const response = await axios.post(`http://mcvapi.azurewebsites.net/registro`, {
...
export const REGISTRO_CLIENTE = async (values) => {
    try {
        ...
        const response = await axios.post(`http://mcvapi.azurewebsites.net/registro/registro_cliente`, {
